	...
	class Shoestrap_Menus {
		...
		function options( $sections ) {
			...
			$fields[] = array(
				...
				'desc'        => __( "Ya ou can activate or deactivate your Primary NavBar here, and define its properties. Please note that you might have to manually create a menu if it doesn't already exist.", 'shoestrap' ),
				'type'        => 'info'
			);
