...
if ( ! class_exists( 'Shoestrap_Typography' ) ) {
	...
	class Shoestrap_Typography {
		...
		function options( $sections ) {
			...
			// Typography Options
			$section = array(
				'title'   => __( 'Typografia', 'shoestrap' ),
				'icon'    => 'el-icon-font',
			);

			$fields[] = array(
				'title'     => __( 'Główny Font', 'shoestrap' ),
				'desc'      => __( '', 'shoestrap' ),
				'id'        => 'font_base',
				'compiler'  => false,
				'units'     => 'px',
			...
			$fields[] = array(
				...
				'preview'   => array(
					'text'        => __( 'This is my preview text!', 'shoestrap' ), //this is the text from preview box
					'font-size'   => '63px' //this is the text size from preview box
				),
				'type'      => 'typography',
				'output'    => 'h1, .h1',
			);
			...
			$fields[] = array(
				...
				'preview'   => array(
					'text'    => __( 'This is my preview text!', 'shoestrap' ), //this is the text from preview box
					'font-size'   => '18px' //this is the text size from preview box
				),
				'type'      => 'typography',
				'output'    => 'h4, .h4',
			);
